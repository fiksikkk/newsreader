...
import DisplayPosts from '../src/components/screens/Home-displayPosts';

describe('DisplayPosts component', () => {
  ...
  it('should render cards when whe loading is false', async () => {
    const wrapper = render(
      <MockedProvider addTypename={false} mocks={[mock]}>
        <DisplayPosts />
      </MockedProvider>,
